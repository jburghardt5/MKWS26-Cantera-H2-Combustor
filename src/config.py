...
# --- Laminar flame speed (FreeFlame) ---

FLAME_SPEED_UNBURNED_TEMPERATURE_K = 300.0
FLAME_SPEED_PRESSURE_ATM = 1.0
...
FLAME_SPEED_DOMAIN_WIDTH_M = 0.03
FLAME_SPEED_REFINE_RATIO = 3.0
FLAME_SPEED_REFINE_SLOPE = 0.06
FLAME_SPEED_REFINE_CURVE = 0.12
FLAME_SPEED_TRANSPORT_MODEL = "multicomponent"
FLAME_SPEED_SORET_ENABLED = True
