...
\begin{titlepage}
  ...
  \vspace{1.2cm}
  {\large Komputerowe Metody w Spalaniu\par}
  \vfill
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.68\textwidth]{ignition_delay_vs_h2_fraction.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.62\textwidth]{flame_speed_grid_convergence.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.70\textwidth]{combustor_ch4_conversion_vs_residence_time.png}
